...
import 'package:libre_mercado_final_app/providers/reputation_provider.dart';
import 'package:libre_mercado_final_app/models/rating_model.dart';
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildRatingCard(rating as Rating);
        },
      ),
    );
  }
