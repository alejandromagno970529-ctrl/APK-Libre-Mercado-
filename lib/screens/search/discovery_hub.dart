...
class _DiscoveryHubState extends State<DiscoveryHub> {
  ...
  Future<void> _loadPopularProducts() async {
    try {
      final productProvider = context.read<ProductProvider>();
      _popularProducts = await productProvider.getPopularProducts(limit: 6);
    } catch (e) {
  ...
  String _getShortCategoryName(String category) {
    final shortNames = {
      ...
      'Videojuegos': 'Gaming',
      'Alimentos y bebidas': 'Alimentos', // ✅ ACTUALIZADO
      'Libros': 'Libros',
    };
  ...
  // ✅ ACTUALIZADO: Color para "Alimentos y bebidas"
  Color _getCategoryColor(String category) {
    final colors = {
      ...
      'Alimentos y bebidas': Colors.brown, // ✅ ACTUALIZADO
  ...
  // ✅ ACTUALIZADO: Ícono para "Alimentos y bebidas"
  IconData _getCategoryIcon(String category) {
    switch (category) {
      ...
      case 'Alimentos y bebidas': // ✅ ACTUALIZADO
