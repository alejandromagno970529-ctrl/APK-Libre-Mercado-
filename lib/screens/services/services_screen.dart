...
class _ServicesScreenState extends State<ServicesScreen> {
          ...
          PopupMenuButton<String>(
            ...
            onSelected: (value) {
              if (value == 'my_services') {
                ...
                _refreshServices();
              } else if (value == 'provider_profile') {
                _navigateToProviderProfile(context);
              }
            },
            itemBuilder: (context) => [
              const PopupMenuItem(
              ...
              const PopupMenuItem(
                ...
                child: Row(
                  children: [
                    Icon(Icons.person_outline_rounded, size: 20, color: Colors.black87),
                    SizedBox(width: 12),
                    Text('Mi perfil de proveedor', style: TextStyle(fontSize: 15)),
                  ],
                ),
              ),
              const PopupMenuItem(
  ...
  Widget _buildCategoryItem(Map<String, dynamic> category, int index) {
    return Consumer<ServiceProvider>(
      builder: (context, provider, child) {
        // CORREGIDO: Usar category['name'] en lugar de category['id']
        ...
        return GestureDetector(
          onTap: () {
            ...
            if (isSelected && provider.selectedCategory != null) {
              ...
              // CORREGIDO: Pasar category['name'] en lugar de category['id']
              provider.fetchServices(category: category['name']);
            }
          },
  ...
  Widget _buildEmptyState(ServiceProvider provider) {
    ...
    final isLoggedIn = authProvider.isLoggedIn;
    final hasServices = authProvider.currentUser != null 
            ...
            children: [
              ...
              Text(
                provider.selectedCategory != null
                    ...
                    : isLoggedIn && hasServices
                        ? '¡Mira tus servicios en "Mis servicios"!'
              ...
              if (isLoggedIn && !hasServices) const SizedBox(height: 12),
