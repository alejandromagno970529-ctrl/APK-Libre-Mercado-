// lib/screens/product/category_products_screen.dart - VERSIÓN COMPLETA CORREGIDA
  ...
  List<Product> _sortProducts(List<Product> products) {
    switch (_selectedSort) {
      case 'Precio: menor a mayor':
        // ✅ CORREGIDO: Manejo seguro de precios nulos
        products.sort((a, b) {
          // Si ambos precios son nulos, son iguales
          if (a.precio == null && b.precio == null) return 0;
          // Si a es nulo, va al final
          if (a.precio == null) return 1;
          // Si b es nulo, a va primero
          if (b.precio == null) return -1;
          // Ambos tienen precio, comparar normalmente
      ...
      case 'Precio: mayor a menor':
        ...
        products.sort((a, b) {
          ...
          // Si b es nulo, a va primero
          if (b.precio == null) return -1;
          // Ambos tienen precio, comparar en orden inverso
