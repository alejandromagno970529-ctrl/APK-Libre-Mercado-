...
import 'package:libre_mercado_final_app/providers/store_provider.dart';
import 'package:libre_mercado_final_app/models/product_model.dart';
import 'package:libre_mercado_final_app/models/store_model.dart';
import 'package:libre_mercado_final_app/widgets/product_search_list_item.dart';
import 'package:libre_mercado_final_app/widgets/product_card.dart';
import 'package:libre_mercado_final_app/widgets/store_card.dart';
...
import 'package:libre_mercado_final_app/screens/search/discovery_hub.dart';
import 'package:libre_mercado_final_app/screens/search/real_time_search_suggestions.dart';
import 'package:libre_mercado_final_app/services/search_history_service.dart';
import 'package:libre_mercado_final_app/screens/store_screen.dart';
  ...
  Future<void> _startChatWithSeller(Product product) async {
    ...
    try {
      final chatId = await chatProvider.getOrCreateChat(
        ...
        sellerId: product.userId, buyerName: '', productTitle: '', serviceId: '',
      );
