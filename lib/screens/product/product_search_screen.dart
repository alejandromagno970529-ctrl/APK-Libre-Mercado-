...
class _ProductSearchScreenState extends State<ProductSearchScreen> 
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const Text(
              'Próximamente podrás buscar productos tomando una foto.',
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Búsqueda por cámara - En desarrollo'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      resizeToAvoidBottomInset: false, // IMPORTANTE: false para evitar conflictos
      appBar: AppBar(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            return KeyboardListener(
              ...
              child: Column(
                children: [
                  // ✅ ZONA DE BÚSQUEDA CON ALTURA FLEXIBLE
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // ✅ SUGERENCIAS CON COMPORTAMIENTO MEJORADO
                  ...
                  // ✅ CONTENIDO PRINCIPAL CON GESTIÓN DE TECLADO
                  Expanded(
  ...
  // ✅ CONTENIDO CON TECLADO ABIERTO
  Widget _buildContentWithKeyboard() {
    return TabBarView(
      controller: _tabController,
      children: [
        _searchController.text.isEmpty && _selectedCategory == 'Todos'
            ? const SizedBox() // No mostrar DiscoveryHub con teclado abierto
            : _buildProductListView(),
