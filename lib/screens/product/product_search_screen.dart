// lib/screens/product/product_search_screen.dart - VERSIÓN COMPLETA MEJORADA
            ...
            setState(() {
              if (result.finalResult) {
                ...
                if (result.recognizedWords.isNotEmpty) {
                  SearchHistoryService.saveSearch(result.recognizedWords);
                }
              }
            });
          },
            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // Distancia máxima
                  const SizedBox(height: 16),
                  const Text('Distancia máxima (km)'),
                  Slider(
                    value: _maxDistance ?? 50,
                    min: 1,
                    max: 100,
                    divisions: 10,
                    label: _maxDistance?.round().toString() ?? '50',
                    onChanged: (value) {
                      setState(() {
                        _maxDistance = value;
                      });
