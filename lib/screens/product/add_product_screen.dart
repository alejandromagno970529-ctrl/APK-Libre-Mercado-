...
class _AddProductScreenState extends State<AddProductScreen> with SingleTickerProviderStateMixin {
  ...
  // ✅ MÉTODO SIMPLIFICADO PARA PUBLICAR PRODUCTO - CORREGIDO
  Future<void> _publishProduct() async {
    ...
    try {
      ...
      // ✅ CÓDIGO CORREGIDO: Usar try-catch en lugar de asignar a variable error
      try {
  ...
  // ✅ MÉTODO PARA CREAR HISTORIA - CORREGIDO
