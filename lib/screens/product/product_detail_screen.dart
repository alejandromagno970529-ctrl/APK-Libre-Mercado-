...
import 'package:libre_mercado_final_app/constants/app_colors.dart';
import 'package:libre_mercado_final_app/utils/time_utils.dart';
  ...
  void _contactSeller() async {
    ...
    try {
      ...
      final chatId = await chatProvider.getOrCreateChat(
        ...
        sellerId: _currentProduct!.userId, buyerName: '', productTitle: '', serviceId: '',
      );
