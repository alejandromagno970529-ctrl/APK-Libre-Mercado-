  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // ✅ BOTÓN DE PUBLICAR EN FORMA DE PALOMILLA EN LA PARTE SUPERIOR DERECHA
    ...
    if (_selectedImages.isNotEmpty) {
      return Column(
        children: [
          ...
          // ✅ BOTÓN "AGREGAR MÁS" CENTRADO EN LA PARTE INFERIOR
          Container(
            ...
            child: _selectedImages.length < 5 
                ...
                : const SizedBox(), // Espacio vacío cuando ya hay 5 imágenes
          ),
        ],
      );
    }
  ...
  Widget _buildImagePreview(File imageFile, int index) {
    return Stack(
      children: [
        ...
        if (_selectedImages.length > 1)
          Positioned(
            top: 70, // Ajustado para no interferir con el AppBar
            right: 16,
