  ...
  Future<void> _pickImage() async {
    try {
      ...
      if (image != null && mounted) {
        ...
        // ✅ CORREGIDO: Usar el provider existente en lugar de crear uno nuevo
        final editorProvider = Provider.of<StoryEditorProvider>(context, listen: false);
        
        // Configurar la imagen en el provider existente
        editorProvider.setBackgroundImage(bytes);
        
        // ✅ NAVEGACIÓN SIMPLIFICADA - Sin crear nuevo Provider
        if (mounted) {
          Navigator.push(
            context,
            MaterialPageRoute(
