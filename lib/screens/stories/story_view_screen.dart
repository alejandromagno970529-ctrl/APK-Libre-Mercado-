...
class _StoryViewScreenState extends State<StoryViewScreen> with SingleTickerProviderStateMixin {
      ...
      body: GestureDetector(
        ...
        child: Stack(
          children: [
            ...
            // ✅ HEADER MEJORADO CON BOTÓN DE PERFIL E ICONO CIRCULAR
            Positioned(
              top: 60,
              left: 16,
              right: 16,
              child: GestureDetector(
                onTap: () => _navigateToUserProfile(_currentStory.userId),
                child: Container(
                  ...
                  child: Row(
                    children: [
                      // ✅ ICONO CIRCULAR CON INICIAL DEL USUARIO
                      Container(
                        width: 44,
                        height: 44,
                        decoration: BoxDecoration(
            ...
            // ✅ BOTÓN DE ELIMINAR EN EL CENTRO INFERIOR
            if (!_isDeleting && _isOwnerOfCurrentStory(currentUserId))
              Positioned(
                bottom: 40,
                left: 0,
                right: 0,
  ...
  // ✅ MÉTODO COMPLETADO PARA NAVEGAR AL PERFIL DEL USUARIO
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ProfileScreen(
          userId: userId,
          isCurrentUser: false, // ✅ Indicar que es perfil de otro usuario
        ),
      ),
    );
  }
