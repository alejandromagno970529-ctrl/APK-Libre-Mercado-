...
import 'package:libre_mercado_final_app/constants/app_dimens.dart';
...
class _CatalogScreenState extends State<CatalogScreen> {
  ...
  Future<void> _startChatWithSeller(Product product) async {
    ...
    try {
      // Usar solo email por ahora - necesitamos revisar el modelo AppUser para ver qué propiedades tiene
      final chatId = await chatProvider.getOrCreateChat(
        productId: product.id,
        buyerId: currentUser.id,
        sellerId: product.userId,
        buyerName: currentUser.email, // ✅ SOLO EMAIL POR AHORA
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                const SizedBox(width: 6),
                _buildCategoryFilter('Alimentos y bebidas'),
                const SizedBox(width: 6),
