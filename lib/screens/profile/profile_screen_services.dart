// 4. CREAR perfil especializado para proveedores de servicios (profile_screen_services.dart) CORREGIDO
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:cached_network_image/cached_network_image.dart';
import '../../providers/auth_provider.dart';
import '../../providers/service_provider.dart';
import '../../models/user_model.dart'; // ✅ CORREGIDO: Importar AppUser correctamente
...
class _ProfileScreenServicesState extends State<ProfileScreenServices> 
  ...
  AppUser? _targetUser; // ✅ CORREGIDO: Cambiado de UserModel a AppUser
  ...
  Future<void> _loadAllData() async {
    ...
    if (widget.isCurrentUser) {
      ...
      // Por ahora, si no es el usuario actual, mostramos vacío
      _userServices = [];
    }
  ...
  AppBar _buildAppBar(AppUser user) { // ✅ CORREGIDO: Cambiado de UserModel a AppUser
    return AppBar(
      backgroundColor: Colors.white,
      elevation: 0,
  ...
  Widget _buildProfileHeader(AppUser user) { // ✅ CORREGIDO: Cambiado de UserModel a AppUser
    return Padding(
  ...
  Widget _buildActionButtons(AppUser user) { // ✅ CORREGIDO: Cambiado de UserModel a AppUser
    if (widget.isCurrentUser) {
      return Row(
        children: [
          Expanded(
  ...
  Widget _buildServicesGrid(AppUser user) { // ✅ CORREGIDO: Cambiado de UserModel a AppUser
  ...
  Widget _buildPortfolioSection(AppUser user) { // ✅ CORREGIDO: Cambiado de UserModel a AppUser
  ...
  Widget _buildReviewsSection(AppUser user) { // ✅ CORREGIDO: Cambiado de UserModel a AppUser
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
