...
import '../../widgets/verification_status_widget.dart' as status_widget;
import '../../widgets/verification_upload_widget.dart' as upload_widget;
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildVerificationSection() {
    ...
    if (isVerified || isPending) {
      return status_widget.VerificationStatusWidget(profileData: _profileData!);
    } 
    // Si no está verificado, mostrar opción para subir documento
    else {
      return upload_widget.VerificationUploadWidget(
