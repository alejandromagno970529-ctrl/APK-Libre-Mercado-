...
import 'package:libre_mercado_final__app/providers/verification_provider.dart';
import 'package:libre_mercado_final__app/widgets/verification_status_widget.dart';
import 'package:libre_mercado_final__app/widgets/verification_upload_widget.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildVerificationSection() {
    ...
    final verificationStatus = _profileData!['verification_status'] as String? ?? 'pending';
    final isVerified = verificationStatus == 'verified';
    final isPending = verificationStatus == 'pending';

    // Si está verificado o pendiente, mostrar estado
    if (isVerified || isPending) {
      return VerificationStatusWidget(profileData: _profileData!);
    } 
    // Si no está verificado, mostrar opción para subir documento
    else {
      return VerificationUploadWidget(
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Reputación: ${(_profileData!['reputation'] as num?)?.toStringAsFixed(1) ?? '0.0'}',
                              style: const TextStyle(
                                fontSize: 12,
        ...
        child: Column(
          ...
          children: [
            ...
            _buildActionTile(
              ...
              onTap: () {
                // Navegar a pantalla de mis productos
