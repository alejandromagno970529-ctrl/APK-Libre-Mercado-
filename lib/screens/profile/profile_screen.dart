...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    try {
      ...
      final productProvider = Provider.of<ProductProvider>(context, listen: false); // ✅ NUEVO
      String targetUserId;
      ...
      if (widget.userId != null) {
        ...
        // ✅ NUEVO: Actualizar perfil y productos del usuario actual
  ...
  // ✅ Obtener título dinámico para AppBar
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // ✅ SECCIÓN: Vista previa de tienda
  ...
  // ✅ MÉTODO: Vista previa de tienda en el perfil
  ...
  Widget _buildActionTile({
    ...
    return ListTile(
      ...
      trailing: Icon(Icons.arrow_forward_ios, size: 16, color: color ?? Colors.grey[600]),
      onTap: onTap,
