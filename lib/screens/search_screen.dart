...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _filterProducts() {
    ...
    // ProductProvider.products nunca es null, es siempre una lista (puede estar vacía)
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Filtros de categoría - CON ALTURA FIJA
          SizedBox(
          ...
          // Lista de productos - CON EXPANDED CORRECTO
          Expanded(
              ...
              builder: (context, productProvider, child) {
                ...
                return RefreshIndicator(
                  ...
                  child: GridView.builder(
                    padding: const EdgeInsets.fromLTRB(16, 0, 16, 16), // ✅ AJUSTADO
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 2,
                      crossAxisSpacing: 10,
                      mainAxisSpacing: 10,
                      childAspectRatio: 0.75, // ✅ CORREGIDO: Cambiado de 0.80 a 0.75
                    ),
