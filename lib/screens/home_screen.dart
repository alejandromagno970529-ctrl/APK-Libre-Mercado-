...
class _HomeContentState extends State<HomeContent> {
  ...
  // Sección de historias - AJUSTADA PARA 12px DE OVERFLOW
  Widget _buildStoriesSection() {
    ...
    return Container(
      height: 76, // ✅ REDUCIDO EN 12px (88px - 12px = 76px)
      padding: const EdgeInsets.only(top: 4, bottom: 4), // ✅ REDUCIDO
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            height: 52, // ✅ REDUCIDO EN 12px (64px - 12px = 52px)
            child: ListView(
  ...
  // Botón para crear historia - MÁS COMPACTO
  Widget _buildCreateStoryButton() {
    return GestureDetector(
      ...
      child: Container(
        margin: const EdgeInsets.only(right: 8), // ✅ REDUCIDO
        width: 55, // ✅ REDUCIDO
        child: Column(
          mainAxisSize: MainAxisSize.min,
          mainAxisAlignment: MainAxisAlignment.start,
          children: [
            // Círculo ultra compacto
            Container(
              width: 45, // ✅ REDUCIDO
              height: 45, // ✅ REDUCIDO
              decoration: BoxDecoration(
                ...
                border: Border.all(color: Colors.grey[300]!, width: 1.0), // ✅ REDUCIDO
              ),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.add, color: Colors.grey[600], size: 16), // ✅ REDUCIDO
                  const SizedBox(height: 0), // ✅ ELIMINADO
                  Text(
                    'Crear',
                    style: TextStyle(fontSize: 7, color: Colors.grey[600]), // ✅ REDUCIDO
                  ),
                ],
              ),
            ),
  ...
  // Widget de círculo de historia - ULTRA COMPACTO
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: story.isAboutToExpire 
                    ? const LinearGradient( // Rojo para historias por expirar
                        colors: [Color(0xFFFD1D1D), Color(0xFFFCAF45)],
                        begin: Alignment.topLeft,
                        end: Alignment.bottomRight,
                      )
                    : const LinearGradient( // Colores normales
              ...
              padding: const EdgeInsets.all(1.0), // ✅ REDUCIDO
              child: Container(
                decoration: BoxDecoration(
                  color: Colors.white,
                  shape: BoxShape.circle,
                ...
                child: story.imageUrl.isEmpty
                    ? Icon(Icons.person, color: Colors.grey[400], size: 14) // ✅ REDUCIDO
                    : null,
              ),
            ),
            const SizedBox(height: 1), // ✅ REDUCIDO
