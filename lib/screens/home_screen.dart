...
import 'package:libre_mercado_final__app/screens/stories/create_story_screen.dart';
...
class _HomeContentState extends State<HomeContent> {
      ...
      body: _isLoading
          ...
          : RefreshIndicator(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  // Sección de historias - REDISEÑADA SIN OVERFLOW
                  _buildStoriesSection(authProvider),
                  // Categorías
                  SliverToBoxAdapter(
  ...
  // Sección de historias - REDISTRIBUCIÓN INTELIGENTE DEL ESPACIO
  Widget _buildStoriesSection(AuthProvider authProvider) {
    ...
    return SliverToBoxAdapter(
      child: Container(
        // ELIMINAMOS LA ALTURA FIJA Y USAMOS PADDING INTELIGENTE
        padding: const EdgeInsets.only(top: 4, bottom: 8), // REDUCIMOS TOP PADDING
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10), // MANTENEMOS ESPACIO CONSISTENTE
            // CONTENEDOR FLEXIBLE SIN ALTURA FIJA
            Container(
              height: 82, // AUMENTAMOS ALTURA PARA CÍRCULOS MÁS GRANDES
  ...
  // Botón para crear historia - CÍRCULOS SIGNIFICATIVAMENTE MÁS GRANDES
  Widget _buildCreateStoryButton() {
    return GestureDetector(
      ...
      child: Container(
        ...
        width: 72, // CONTENEDOR MÁS ANCHO
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            // CÍRCULO MUCHO MÁS GRANDE
            Container(
              width: 58, // 25% MÁS GRANDE que 46px
              height: 58, // 25% MÁS GRANDE que 46px
              decoration: BoxDecoration(
                color: Colors.grey[100],
                shape: BoxShape.circle,
                border: Border.all(color: Colors.grey[300]!, width: 1.8),
              ),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.add, color: Colors.grey[600], size: 20), // ICONO MÁS GRANDE
            ...
            const SizedBox(height: 6), // ESPACIO OPTIMIZADO
            // Texto mejorado
            Text(
              'Tu historia',
              style: const TextStyle(
                fontSize: 11, // TEXTO MÁS LEGIBLE
  ...
  // Widget de círculo de historia - CÍRCULOS MUCHO MÁS GRANDES
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            // CÍRCULO MUCHO MÁS GRANDE CON GRADIENTE
            Container(
              width: 58, // 25% MÁS GRANDE que 46px
              height: 58, // 25% MÁS GRANDE que 46px
              decoration: BoxDecoration(
              ...
              child: Container(
                ...
                child: story.imageUrl.isEmpty
                    ? Icon(Icons.person, color: Colors.grey[400], size: 18) // ICONO MÁS GRANDE
                    : null,
              ),
            ),
            const SizedBox(height: 6), // ESPACIO OPTIMIZADO
