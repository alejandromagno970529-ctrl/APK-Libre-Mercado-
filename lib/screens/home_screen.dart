...
class _HomeContentState extends State<HomeContent> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              height: 100, // AUMENTAMOS ALTURA PARA CÍRCULOS MÁS GRANDES
  ...
  // Botón para crear historia - CÍRCULOS AÚN MÁS GRANDES
  Widget _buildCreateStoryButton() {
    return GestureDetector(
      ...
      child: Container(
        margin: const EdgeInsets.only(right: 16), // Más espacio entre círculos
        width: 90, // CONTENEDOR MÁS ANCHO
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            // CÍRCULO AÚN MÁS GRANDE
            Container(
              width: 76, // AUMENTADO de 70 a 76
              height: 76, // AUMENTADO de 70 a 76
              decoration: BoxDecoration(
              ...
              child: Column(
                ...
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.add, color: Colors.grey[600], size: 28), // ICONO MÁS GRANDE
  ...
  // Widget de círculo de historia - CÍRCULOS AÚN MÁS GRANDES
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            // CÍRCULO AÚN MÁS GRANDE CON GRADIENTE
            Container(
              width: 76, // AUMENTADO de 70 a 76
              height: 76, // AUMENTADO de 70 a 76
              decoration: BoxDecoration(
              ...
              padding: const EdgeInsets.all(3.0), // Borde un poco más grueso
              child: Container(
                decoration: BoxDecoration(
                  color: Colors.white,
                  shape: BoxShape.circle,
                ...
                child: story.imageUrl.isEmpty
                    ? Icon(Icons.person, color: Colors.grey[400], size: 24) // ICONO MÁS GRANDE
                    : null,
              ),
            ),
            const SizedBox(height: 6),
