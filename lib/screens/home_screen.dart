...
import 'package:libre_mercado_final__app/screens/product/product_search_screen.dart'; // ✅ CORREGIDO
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Widget> _screens = [
    const HomeContent(),
    const ProductSearchScreen(), // ✅ CORREGIDO: SearchScreen -> ProductSearchScreen
  ...
  void _performSearch(String query) {
    if (query.isNotEmpty) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ProductSearchScreen(initialQuery: query), // ✅ CORREGIDO: SearchScreen -> ProductSearchScreen
        ),
      );
    }
  }
      ...
      if (mounted) {
        Navigator.push(context, MaterialPageRoute(
          builder: (context) => ChatScreen(
            chatId: chatId,
            productId: product.id, // ✅ MANTENIDO: productId requerido
    ...
    return SliverPadding(
      ...
      sliver: SliverGrid(
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          ...
          crossAxisSpacing: 12,
          mainAxisSpacing: 12,
          childAspectRatio: 0.68, // ✅ ASPECT RATIO CORREGIDO - ORIGINAL QUE FUNCIONABA
        ),
