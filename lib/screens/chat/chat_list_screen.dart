...
class _ChatListScreenState extends State<ChatListScreen> {
  ...
  Map<String, Map<String, dynamic>> _userPresence = {};
  ...
  Future<void> _loadChats() async {
    ...
    if (authProvider.currentUser != null) {
      try {
        ...
        await _loadUserPresence(chatProvider.chatsList, authProvider.currentUser!.id);
      } catch (e) {
        if (mounted) {
  ...
  Future<void> _loadUserPresence(List<Chat> chats, String currentUserId) async {
    _presenceService = PresenceService();
    final newPresence = <String, Map<String, dynamic>>{};
    ...
    for (final chat in chats) {
      try {
        ...
        if (presence != null) {
          newPresence[chat.id] = presence;
        // ignore: dead_code
        } else {
          // FIX: Convertimos DateTime a String para evitar el error de tipo
          newPresence[chat.id] = {
            'online': false,
        ...
        // FIX: Convertimos DateTime a String aquí también
        newPresence[chat.id] = {
          'online': false,
          'last_seen': chat.updatedAt.toIso8601String(),
        };
  ...
  Widget _buildChatItem(Chat chat, ChatProvider chatProvider, String currentUserId) {
    ...
    // FIX: Manejo robusto de tipos para last_seen
    DateTime? lastSeen;
            ...
            children: [
              ...
              Stack(
                children: [
                  ...
                  _buildNotificationBadge(chat.unreadCount),
                ],
              ),
