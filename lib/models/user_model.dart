class AppUser {
  ...
  int get storeTotalProducts => storeStats?['total_products'] ?? 0;
  ...
  // ... (MANTENER TODOS LOS GETTERS EXISTENTES SIN CAMBIOS)
  ...
  @override
  String toString() {
    return 'AppUser{id: $id, email: $email, username: $username, hasStore: $hasStore, storeName: $storeName}';
  }
