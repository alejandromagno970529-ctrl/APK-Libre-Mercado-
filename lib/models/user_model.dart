// lib/models/user_model.dart - VERSIÓN COMPLETA CORREGIDA
class AppUser {
  final String id;
  final String email;
  ...
  factory AppUser.fromMap(Map<String, dynamic> map) {
    return AppUser(
      ...
      verificationDocumentUrl: map['verification_document_url'] as String?,
      verificationSubmittedAt: map['verification_submitted_at'] != null 
          ? DateTime.parse(map['verification_submitted_at']) 
          : null,
      verificationReviewedAt: map['verification_reviewed_at'] != null
          ? DateTime.parse(map['verification_reviewed_at'])
          : null,
  ...
  // ✅ GETTERS PARA PRESENCIA EN LÍNEA
  ...
  @override
  String toString() {
    return 'AppUser{id: $id, email: $email, username: $username, hasStore: $hasStore, verificationStatus: $verificationStatus, actualProductCount: $actualProductCount, isOnline: $isOnline}';
  }
