class Chat {
  ...
  final String? otherUserAvatar; // ✅ NUEVO: Avatar del otro usuario
  ...
  factory Chat.fromMap(Map<String, dynamic> map) {
    ...
    return Chat(
      ...
      otherUserAvatar: map['other_user_avatar'] as String?, // ✅ NUEVO
    );
  }
  ...
  Chat copyWith({
    ...
    return Chat(
      ...
      otherUserAvatar: otherUserAvatar ?? this.otherUserAvatar, // ✅ NUEVO
    );
  }
}