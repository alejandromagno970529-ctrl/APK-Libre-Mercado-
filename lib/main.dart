  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        // ✅ NUEVO: StoryEditorProvider agregado al MultiProvider
        ChangeNotifierProvider<StoryEditorProvider>(
            ...
            case '/story-editor':
              ...
              if (args != null && args.containsKey('imageBytes')) {
                ...
                if (imageBytes is List<int>) {
                  ...
                  // Si no hay imagen válida, redirigir a CreateStoryScreen
                  return MaterialPageRoute(
                    builder: (context) => const CreateStoryScreen(),
                  );
                }
                
                // ✅ CORREGIDO: Usar el provider existente y configurar la imagen
                return MaterialPageRoute(
                  builder: (context) {
                    // Configurar la imagen en el provider existente
                    final editorProvider = Provider.of<StoryEditorProvider>(context, listen: false);
                    editorProvider.setBackgroundImage(uint8list);
                    
                    return StoryEditorScreen(imageBytes: uint8list);
                  },
                );
              }
              // Si no hay argumentos, redirigir a CreateStoryScreen
              return MaterialPageRoute(
                builder: (context) => const CreateStoryScreen(),
              );
