...
// ✅ IMPORTACIONES CORREGIDAS PARA ONBOARDING Y PERFIL DE PROVEEDORES
import 'screens/onboarding/service_provider_onboarding_screen.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          // ✅ RUTAS CORREGIDAS PARA ONBOARDING Y PERFIL DE PROVEEDORES
          '/service-provider-onboarding': (context) => const ServiceProviderOnboardingScreen(),
          '/service-provider-profile': (context) => const ProfileScreenServices(),
        },
        onGenerateRoute: (settings) {
          switch (settings.name) {
            ...
            // ✅ NUEVO CASO: Perfil de proveedor de servicios CORREGIDO
            case '/service-provider-profile':
              final args = settings.arguments as Map<String, dynamic>?;
              return MaterialPageRoute(
                builder: (context) => ProfileScreenServices(
                  userId: args?['userId'],
...
class NavigationHelper {
  ...
  // ✅ NUEVO: Navegación a onboarding de proveedores
  static void navigateToServiceProviderOnboarding(BuildContext context) {
    Navigator.pushNamed(context, '/service-provider-onboarding');
  }

  // ✅ NUEVO: Navegación a perfil de proveedor
  static void navigateToServiceProviderProfile(BuildContext context, {
    String? userId,
