              ...
              if (args != null && 
                ...
                return MaterialPageRoute(
                  builder: (context) => StoryViewScreen(
                    stories: args['stories'], // ✅ CORRECCIÓN: Pasar stories
                    initialIndex: args['initialIndex'], // ✅ CORRECCIÓN: Pasar initialIndex
                    isOwner: args['isOwner'], // ✅ CORRECCIÓN: Pasar isOwner
                  ),
                );
              }
              // ✅ CORRECCIÓN: Si no hay argumentos, redirigir a home
              return MaterialPageRoute(
