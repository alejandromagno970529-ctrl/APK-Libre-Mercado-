// lib/main.dart - VERSIÓN COMPLETAMENTE ACTUALIZADA CON STOREPROVIDER
...
import 'providers/store_provider.dart'; // ✅ NUEVO PROVIDER
...
import 'screens/product/product_search_screen.dart'; // ✅ IMPORTACIÓN CORREGIDA
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<StoreProvider>( // ✅ NUEVO PROVIDER
          create: (_) => StoreProvider(Supabase.instance.client),
        ),
      ],
      child: Builder(
        builder: (context) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            try {
              ...
              AppLogger.d('🔗 ProductProvider registrado con StoreProvider');
            } catch (e) {
              AppLogger.w('⚠️ No se pudo registrar ProductProvider con StoreProvider: $e');
            }
          });
        ...
        routes: {
          ...
          '/search': (context) => const ProductSearchScreen(), // ✅ RUTA CORREGIDA
  ...
  ), // child Builder of MultiProvider
); // MultiProvider
  }
}
...
class _AuthWrapperState extends State<AuthWrapper> {
  ...
  Future<void> _initializeApp() async {
    try {
      ...
      final productProvider = Provider.of<ProductProvider>(context, listen: false);
      final storeProvider = Provider.of<StoreProvider>(context, listen: false); // ✅ NUEVO
      
      // ✅ ACTUALIZADO: Inicializar providers en paralelo
      await Future.wait([
        authProvider.initialize(),
        productProvider.initialize(),
        storeProvider.fetchAllStores(), // ✅ NUEVO: Cargar tiendas al iniciar
      ]);
...
class _AuthStateHandlerState extends State<AuthStateHandler> {
  ...
  Future<void> _checkAuthStatus() async {
    try {
      ...
      // Verificar sesión en Supabase directamente
      ...
      AppLogger.d('🏪 Tiendas cargadas: ${storeProvider.stores.length}'); // ✅ NUEVO
      
      if (session != null && user != null) {
        AppLogger.d('✅ Sesión activa encontrada - Cargando perfil...');
        await authProvider.loadUserProfile(user.id);
        
        // ✅ NUEVO: Recargar tiendas si es necesario
        ...
        // ✅ NUEVO: Asegurar que las tiendas estén cargadas incluso sin sesión
        if (storeProvider.stores.isEmpty) {
...
class ErrorHandler {
  ...
  // ✅ NUEVO: Manejo de errores específicos de tiendas
...
class NavigationHelper {
  ...
  // ✅ NUEVOS MÉTODOS PARA NAVEGACIÓN DE TIENDA
  ...
  // ✅ NUEVO: Método para navegar a búsqueda
  ...
  // ✅ NUEVO: Método para navegar a categorías de productos
...
''');
  ...
  // ✅ NUEVO: Verificar estado de tiendas
...
extension ContextExtensions on BuildContext {
  ...
  StoreProvider get storeProvider => Provider.of<StoreProvider>(this, listen: false); // ✅ NUEVO
  ...
  void handleStoreError(String error) => ErrorHandler.handleStoreError(this, error); // ✅ NUEVO
  void handleNetworkError() => ErrorHandler.handleNetworkError(this);

  // Estado de la aplicación
  void logAppState() => AppStateManager.logAppState(this);
  void checkStoreState() => AppStateManager.checkStoreState(this); // ✅ NUEVO
