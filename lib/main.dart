...
class _AuthWrapperState extends State<AuthWrapper> {
  ...
  Future<void> _initializeApp() async {
    try {
      ...
      // ✅ INICIALIZAR CHAT PROVIDER Y CONEXIONES
      productProvider.registerStoreProvider(storeProvider);
      
      // ✅ VERIFICAR QUE LOS SERVICIOS DE CHAT ESTÉN READOS
      AppLogger.d('🔧 Inicializando servicios de chat...');
      AppLogger.d('📡 ChatService: ${chatProvider.chatsList.length} chats cargados');
      ...
      // En tu main.dart o donde inicialices los servicios
  ...
  Future<void> _checkAuthStatus() async {
    try {
      ...
      if (session != null && user != null) {
        ...
        // ✅ LIMPIAR CHATS SI NO HAY SESIÓN
