// lib/main.dart - VERSIÓN CORREGIDA Y COMPLETA
...
import 'screens/product/search_screen.dart'; // ✅ CORREGIDO: Nombre correcto
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/search': (context) => const ProductSearchScreen(), // ✅ CORREGIDO
          '/catalog': (context) => const CatalogScreen(),
          '/map': (context) => const MapScreen(),
          '/profile': (context) => const ProfileScreen(),
          '/edit-profile': (context) => const EditProfileScreen(),
          '/chats': (context) => const ChatListScreen(),
          '/ratings': (context) => const RatingsListScreen(),
        },
          ...
          switch (settings.name) {
            ...
            case '/chat':
              ...
              if (args != null && 
                  ...
                  args.containsKey('otherUserId')) { // ✅ CORREGIDO: otherUserId en lugar de otherUser
                return MaterialPageRoute(
                  builder: (context) => ChatScreen(
                    chatId: args['chatId'],
                    otherUserId: args['otherUserId'], // ✅ CORREGIDO
                  ),
                );
              }
              return MaterialPageRoute(
            ...
            case '/rate-user':
              final args = settings.arguments as Map<String, dynamic>?;
              if (args != null && 
                  args.containsKey('toUserId') && // ✅ CORREGIDO: toUserId
                  args.containsKey('userName')) {
                return MaterialPageRoute(
                  builder: (context) => RatingScreen(
                    toUserId: args['toUserId'], // ✅ CORREGIDO
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    ...
                    color: Colors.white.withOpacity(0.3), // ✅ CORREGIDO: .withOpacity no está deprecated en BoxShadow
                    blurRadius: 10,
                    spreadRadius: 2,
                  ),
                ],
...
class AuthStateHandler extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Redirigir al home si está autenticado, al login si no
    return authProvider.isLoggedIn ? const HomeScreen() : const LoginScreen();
  }
}

// Widget para manejar errores globales
class ErrorHandler {
