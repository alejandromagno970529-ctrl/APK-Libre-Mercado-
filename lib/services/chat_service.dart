  ...
  Future<List<Chat>> getUserChats(String userId) async {
    try {
      ...
      final response = await _supabase
          ...
          ''') // <<-- CONSULTA SQL AHORA LIMPIA DE COMENTARIOS
      ...
      final chats = (response as List).map((data) {
        ...
        // Determinar el otro usuario y su información usando los alias 'seller' y 'buyer'
        final isSeller = userId == chat.sellerId;
        final otherUserProfile = isSeller ? data['buyer'] : data['seller'];
