// lib/widgets/products_map_view.dart - VERSIÓN OPTIMIZADA
...
class _ProductsMapViewState extends State<ProductsMapView> {
  ...
  void _processProducts() {
    // Filtrar productos con ubicación de manera eficiente
    ...
    return const Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text(
            'Cargando ubicación de productos...', // Mensaje actualizado
            style: TextStyle(
              fontSize: 16,
              color: Colors.grey,
            ),
