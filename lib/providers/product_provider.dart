// lib/providers/product_provider.dart - VERSIÓN ACTUALIZADA PARA MÚLTIPLES IMÁGENES
...
class ProductProvider with ChangeNotifier {
  ...
  // ✅ MÉTODO ACTUALIZADO: Crear producto con múltiples imágenes
  Future<String?> createProductWithLocation({
    ...
    required List<String>? imagenUrls, // ✅ CAMBIADO A LISTA
    ...
    try {
      ...
      // ✅ DATOS COMPATIBLES CON AMBAS VERSIONES
      final productData = {
        'titulo': titulo,
        ...
        'moneda': moneda,
        'imagen_urls': imagenUrls, // ✅ NUEVO CAMPO (array)
        'imagen_url': imagenUrls?.isNotEmpty == true ? imagenUrls!.first : null, // ✅ COMPATIBILIDAD
  ...
  // ✅ MÉTODO: Actualizar imagen del producto (ahora para múltiples imágenes)
