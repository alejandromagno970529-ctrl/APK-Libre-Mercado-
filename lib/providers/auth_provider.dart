...
class AuthProvider with ChangeNotifier {
  ...
  // ✅ CORREGIDO: Método debugAuthState sin usar propiedades no disponibles
  ...
  // ✅ MÉTODO: Verificar credenciales sin iniciar sesión
  Future<Map<String, dynamic>> verifyCredentials(String email, String password) async {
    try {
      ...
      if (response.user != null && response.session != null) {
        // Si funciona, cerrar sesión inmediatamente (solo era una verificación)
  ...
  // ✅ MÉTODO: Reenviar verificación de email
  ...
  // ✅ MÉTODO: Limpiar el estado de autenticación
    ...
    try {
      ...
      await _supabase
          ...
          .insert({
            ...
            // ✅ NUEVO: INICIALIZAR CAMPOS DE TIENDA
  ...
  // ✅ MÉTODO EXISTENTE: Actualizar perfil de usuario
  ...
  // ✅ NUEVO MÉTODO: Actualizar perfil de tienda
  Future<String?> updateStoreProfile({
    ...
    try {
      ...
      // Si se está habilitando la tienda por primera vez, establecer fecha de creación
  ...
  // ✅ NUEVO MÉTODO: Incrementar estadísticas de tienda
  ...
  // ... (MANTENER TODOS LOS MÉTODOS EXISTENTES SIN CAMBIOS: signUp, signIn, etc.)
