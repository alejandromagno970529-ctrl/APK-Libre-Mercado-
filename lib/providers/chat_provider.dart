...
class ChatProvider with ChangeNotifier {
  ...
  Future<String> getOrCreateChat({
    ...
    required String productTitle, required String serviceId,
  }) async {
    try {
      _setLoading(true);
...
''');
  ...
  Future<void> startChat({required String otherUserId, required String currentUserId, Object? productId, required String serviceId}) async {}
}